...
import diory from "../../src/images/diory.jpg"
...
export default function Navigasi() {
    return (
        <div>
            ...
            <img src={diory} style={{marginRight:"10px"}} alt="" className="rounded-circle align-self-center "/>
            {/* <img src={logo} className="py-1" classNameName="App-logo" alt="logo" /> */}
            <a className="navbar-brand" href="#">
                <p className="fw-bold align-self-center" style={{fontSize: "25px"}}><span style={{color: "#fa2c5a"}}>Sinaga</span><span style={{color: "#e9c00d"}}>Diory</span></p>
            </a>
